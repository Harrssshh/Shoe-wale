...
export function WhatsAppButton() {
  ...
  useEffect(() => {
    ...
    const handleResize = () => {
      setKeyboardOpen(initialHeight - viewport.height > 150);
    };
  ...
  return (
    <motion.div
      ...
      transition={{ delay: keyboardOpen ? 0 : 2, type: "spring", stiffness: 200, damping: 15 }}
    ...
    >
      ...
      <motion.div whileHover={{ scale: 1.12 }} whileTap={{ scale: 0.92 }}>
        <Link
          href={getWhatsAppLink("Hi Shoes Wale, I want to place an order")}
          target="_blank"
