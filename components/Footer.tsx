...
export function Footer() {
  return (
    <footer className="border-t border-volt/20 bg-pitch px-5 py-8 md:px-8">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 text-sm text-muted md:flex-row">
        <Link href="#" className="font-display text-xl tracking-[3px] text-white transition-colors hover:text-volt">
          SHOES <span className="text-volt">WALE</span>
        </Link>
        <p>© {new Date().getFullYear()} Shoes Wale · Sport Sneakers · Udaipur</p>
